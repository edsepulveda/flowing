    ...
    <MotionHighlightItem disabled={disabled}>
      <DropdownMenuPrimitive.Item ref={ref} {...props} disabled={disabled}>
        <motion.span
          ...
          whileTap={{ scale: 0.95 }}
          className={cn(
            "relative z-[1] flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:ring-0 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
            inset && "pl-8",
            className
          )}
        >
